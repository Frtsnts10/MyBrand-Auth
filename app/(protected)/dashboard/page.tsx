...
function Stat({
  ...
  return (
    <div className="rounded-2xl border border-white/20 dark:border-white/10 p-4 md:p-5 bg-white/40 dark:bg-black/40 backdrop-blur-xl shadow-sm">
    ...
    <div className="space-y-6">
      ...
      <div className="relative mt-2">
        <div className="absolute inset-0 z-10 flex flex-col items-center justify-center rounded-2xl">
          <div className="bg-white/60 dark:bg-black/60 backdrop-blur-2xl border border-white/20 dark:border-white/10 shadow-2xl rounded-2xl p-6 md:p-8 flex flex-col items-center text-center max-w-sm">
        ...
        <div className="xl:col-span-2 rounded-2xl border border-white/20 dark:border-white/10 p-4 md:p-6 bg-white/40 dark:bg-black/40 backdrop-blur-xl shadow-sm">
          <div className="flex items-center justify-between">
        ...
        <div className="rounded-2xl border border-white/20 dark:border-white/10 p-4 md:p-6 bg-white/40 dark:bg-black/40 backdrop-blur-xl shadow-sm">
      ...
      <section className="rounded-2xl border border-white/20 dark:border-white/10 bg-white/40 dark:bg-black/40 backdrop-blur-xl shadow-sm overflow-hidden">
