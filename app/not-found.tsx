...
export default function NotFound() {
  return (
    <main className="flex min-h-screen items-center justify-center px-4 relative bg-gradient-to-br from-slate-100 via-blue-50 to-slate-200 dark:bg-gradient-to-br dark:from-slate-900 dark:via-blue-950 dark:to-slate-900 overflow-hidden">
